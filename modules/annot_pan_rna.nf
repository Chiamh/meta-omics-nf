// Annotation of pangenome aligned clusters (e.g. IHSMGC) which have sufficient MTX read coverage, with Uniref90 labels, Eggnog COG labels and GO terms 
// No need to run eggnog mapper here because all the pangenes have been annotated by eggnog already (pangenome_annots)
process ANNOT_PAN_RNA {
	label "process_high"
	tag "${sample_id}"
